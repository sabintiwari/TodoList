class ListItemsController < ApplicationController
  ...
  # GET /list_items.json
  def index
    @list_items = ListItem.order(:position)
  end
  ...
  def up
    ...
    @list_items = ListItem.order(:position)
    redirect_to list_items_id_path(:id => @list_item.list_id)
    #render 'list_items/index'
  end
  ...
  private
    ...
    def list_item_params
      params.require(:list_item).permit(:name, :description, :position, :list_id)
    end
end
